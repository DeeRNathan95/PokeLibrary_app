...
// Utility functions and constants for the PokéLibrary application
// List of the first 151 Pokémon names
...
// Mapping of Pokémon types to their respective text and background colors
...
// Function to get the Pokédex number (1-based index) from a 0-based index
export function getPokedexNumber(index) {
    return index + 1
}

// Function to get the full Pokédex number as a three-digit string ||?? need to understand this function better************************
